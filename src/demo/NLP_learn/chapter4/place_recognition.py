...
def locationNER(text):
    tagger = load_model('/home/xiaoxinwei/data/NLP_learn_data/learning-nlp/chapter-4/model')
    for c in text:
        tagger.add(c)
...
if __name__ == '__main__':
    f1('/home/xiaoxinwei/data/NLP_learn_data/learning-nlp/chapter-4/data/test.rst')
