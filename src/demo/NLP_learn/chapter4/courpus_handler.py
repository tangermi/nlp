...
def corpus_handler(root_dir):
    train_path = root_dir + 'train.txt'
    with open(root_dir + 'people-daily.txt', encoding='utf8') as corpus_f,\
            open(root_dir + 'train.txt', 'w', encoding='utf8') as train_f,\
            open(root_dir + 'test.txt', 'w', encoding='utf8') as test_f:
        pos = 0  # 用于划分训练集和测试集
...
if __name__ == '__main__':
    corpus_handler(r'/home/xiaoxinwei/data/NLP_learn_data/learning-nlp/chapter-4/data/')
