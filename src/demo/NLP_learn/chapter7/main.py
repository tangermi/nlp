...
def preprocess():
    ...
    """
    count = 0
    zhwiki_path = '/home/xiaoxinwei/data/zhwiki-latest-pages-articles.xml.bz2'
    f = open('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/reduced_zhwiki.txt', 'w', encoding='utf8')
...
def train_w2v():
    with open('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/reduced_zhwiki.txt', 'r', encoding='utf8') as f:
        # 使用gensim的Word2Vec类来生成词向量
        model = Word2Vec(LineSentence(f), sg=0, size=192, window=5,
                         min_count=5, workers=4)
        model.save('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/zhwiki_news.word2vec')



def test_w2v():
    model = Word2Vec.load('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/zhwiki_news.word2vec')
...
def train_d2v():
    ...
    model.save('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/zhwiki_news.doc2vec')
