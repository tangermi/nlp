...
from lib.keyword_extract import get_keyword
...
if __name__ == '__main__':
    root_dir = '/home/xiaoxinwei/data/learning-nlp/chapter-7/'
    model1 = Word2Vec.load(root_dir + 'data/zhwiki_news.word2vec')
    p1 = root_dir + 'word2vec/data/P1.txt'
    p2 = root_dir + 'word2vec/data/P2.txt'
    p1_keywords = root_dir + 'word2vec/data/P1_keywords.txt'
    p2_keywords = root_dir + 'word2vec/data/P2_keywords.txt'
    ...
    model2 = Doc2Vec.load('/home/xiaoxinwei/data/learning-nlp/chapter-7/data/zhwiki_news.doc2vec')
