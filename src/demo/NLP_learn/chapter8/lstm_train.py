...
num_labels = 2
iterations = 100000
ids = np.load('/home/xiaoxinwei/data/learning-nlp/chapter-8/sentiment-analysis/idsMatrix.npy')
word_vectors = np.load('/home/xiaoxinwei/data/learning-nlp/chapter-8/sentiment-analysis/wordVectors.npy')
...
with tf.Session(config=config) as sess:
    ...
    for k in range(iterations):
        ...
        if (k % 10000 == 0 and k != 0) or (k == iterations - 1):
            save_path = saver.save(sess, '/home/xiaoxinwei/data/learning-nlp/chapter-8/sentiment-analysis/models/sentiment.ckpt',
                                   global_step=k)
