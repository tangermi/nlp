...
def get_data():
    ...
    :return:
    """
    with open('/home/xiaoxinwei/data/learning-nlp/chapter-9/classification/data/ham_data.txt', 'r', encoding='utf8') as ham_f,\
            open('/home/xiaoxinwei/data/learning-nlp/chapter-9/classification/data/spam_data.txt', 'r', encoding='utf8') as spam_f:
