...
class Processor:
    ...
    def __init__(self):
        self.encoder_file = '/home/xiaoxinwei/data/learning-nlp/chapter-10/seq2seq/A.txt'
        self.decoder_file = '/home/xiaoxinwei/data/learning-nlp/chapter-10/seq2seq/Q.txt'
