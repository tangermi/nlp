...
CONFIG = {
    ...
    'preprocess': {
        'task': ['ChnSentiCorp_hotel_review'],
        'sogou': {
            # 'in_file': 'ChnSentiCorp_hotel_review',
            '_in': '/apps/data/ai_nlp_testing/raw/training_data_for_sentiment_analysis/ChnSentiCorp_hotel_review',
    ...
    'feature': {
        ...
        'depend': 'preprocess',
        'LSTM': {
            'depend': 'ChnSentiCorp_hotel_review',
            'train_file': 'train.csv',
            'test_file': 'test.csv',
